...
from eventepi.event_db_preprocessing.clean_countries import clean_countries
from eventepi.event_db_preprocessing.clean_counts import clean_counts
from eventepi.event_db_preprocessing.clean_dates import to_datetime
from eventepi.event_db_preprocessing.clean_diseases import clean_diseases
from eventepi.event_db_preprocessing.clean_urls import clean_urls


def test_clean_countries():
    example_countries_to_clean = pd.DataFrame({'country_edb': [' Australien',
                                                               'Kongo \nUSA',
                                                               'Italien (Tirol), Deutschland, Belgien ',
                                                               'Franz._Polynesien',
                                                               'Trinidad & Tobago',
                                                               "Süd Sudan",
                                                               "Süd Korea",
    ...
    expected_clean_countries = pd.DataFrame({'country_edb': ['Australien',
                                                             'Kongo',
                                                             'USA',
                                                             'Italien',
                                                             'Deutschland',
